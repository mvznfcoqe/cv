...
\section{О себе}
Frontend-разработчик с 4+ годами коммерческого опыта в экосистемах Vue/React, работал в командах от 2 до 18 человек. Выстроил полный цикл разработки: от сбора требований до автоматизированного релизного процесса с высоким покрытием тестами, CI/CD и эффективными командными процессами. Провёл миграцию фотомаркетплейса (70K+ DAU, 120K LOC) с PHP-монолита на Vue, ускорив time-to-market для сложных клиентских задач на 60% и сократив онбординг с двух недель до 5–7 дней.
